Pod::Spec.new do |s|
  s.name         = 'CTMobile'
  s.version      = '2.6.12.Mayoly'
  s.summary      = 'The New CT Mobile'
  s.homepage     = 'https://github.com/CT-Software/The-New-CT-Mobile'
  s.license      = 'MIT'
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
  s.source       = { :git => 'git@github.com:CT-Software/The-New-CT-Mobile.git', :branch => '2.6.Mayoly', :commit => 'e6c902223f7e973f45e1d49ed67efe6d4a3bb298' }
  s.platform     = :ios, '12.1'
  s.requires_arc = true
