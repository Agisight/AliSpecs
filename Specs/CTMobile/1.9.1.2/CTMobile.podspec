Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/CT-Consulting/The-New-CT-Mobile.git', :branch => '1.9.1', :tag => s.version }
  s.platform     = :ios, '8.0'
  s.requires_arc = true
  ...
  s.subspec 'Synchronization' do |synchr|
    ...
    synchr.library = 'xml2'
    synchr.xcconfig = { 'HEADER_SEARCH_PATHS' => '$(SDKROOT)/usr/include/libxml2', 'CLANG_ALLOW_NON_MODULAR_INCLUDES_IN_FRAMEWORK_MODULES' => 'YES' }
  ...
  s.subspec 'Core' do |core|
    ...
    core.public_header_files = "Core/Core/**/*.h", "vendored/WindowsAzureMobileServices.framework/Headers/*.h","vendored/WindowsAzureMessaging.framework/Headers/*.h","vendored/Crashlytics.framework/Headers/*.h","vendored/Fabric.framework/Headers/*.h"
    core.libraries = "c++", "z"
