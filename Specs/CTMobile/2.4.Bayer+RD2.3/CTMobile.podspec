Pod::Spec.new do |s|
  s.name         = 'CTMobile'
  s.version      = '2.4.Bayer+RD2.3'
  s.summary      = 'The New CT Mobile'
  s.homepage     = 'https://github.com/CT-Software/The-New-CT-Mobile'
  s.license      = 'MIT'
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4.Bayer+RD2', :commit => '8b272206b5a023de2e15441bc895d9f80cf18db2' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
