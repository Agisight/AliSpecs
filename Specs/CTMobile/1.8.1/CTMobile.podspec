Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/CT-Consulting/The-New-CT-Mobile', :branch => '1.8.1' }
  s.platform     = :ios, '7.0'
  s.requires_arc = true
  ...
  s.subspec 'Synchronization' do |synchr|
    ...
    synchr.dependency 'ZKSforce', '33.0.0'
  ...
  s.subspec 'Core' do |core|
    ...
    core.dependency 'AzureNotificationHubs'
  ...
  s.subspec 'Application' do |app|
    ...
    app.dependency 'WebViewJavascriptBridge', '4.1.5'
 ...
 s.subspec 'Routes' do |routes|
    ...
    routes.dependency 'GoogleMaps', '1.10.5'
...
s.subspec 'NearbyAccounts' do |nearbyaccounts|
    ...
    nearbyaccounts.dependency 'GoogleMaps', '1.10.5'
