Pod::Spec.new do |s|
  s.name         = 'CTMobile'
  s.version      = '2.6.13.Mayoly'
  s.summary      = 'The New CT Mobile'
  s.homepage     = 'https://github.com/CT-Software/The-New-CT-Mobile'
  s.license      = 'MIT'
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
  s.source       = { :git => 'git@github.com:CT-Software/The-New-CT-Mobile.git', :branch => '2.6.Mayoly', :commit => 'd651b595b0045617854b811892e5add7b9f42206' }
  s.platform     = :ios, '12.1'
  s.requires_arc = true
