Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
    core.source_files = 'Core/Core/**/*.{h,m,mm,swift}', "vendored/WindowsAzureMobileServices.framework/Headers/*.h","vendored/WindowsAzureMessaging.framework/Headers/*.h","vendored/Crashlytics.framework/Headers/*.h","vendored/Fabric.framework/Headers/*.h"
