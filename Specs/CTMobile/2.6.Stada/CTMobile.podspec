Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'git@github.com:CT-Software/The-New-CT-Mobile.git', :branch => '2.6.Stada', :commit => 'f20b9eb35684ed9aad6028ea6690cf23e499ed3b' }
  s.platform     = :ios, '12.1'
  s.requires_arc = true
