Pod::Spec.new do |s|
  ...
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
    ...
    #
    # May 11, 2021
    # CTM-3958 Вылет приложения при быстрой синхронизации после удаления записей из календаря с постоянным ID
    # etrishina
    # https://github.com/CT-Software/The-New-CT-Mobile/commit/37f0823014b9597a3c51a633106f46bfc0e9f99b

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4', :commit => '37f0823014b9597a3c51a633106f46bfc0e9f99b' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
  ...
  "vendored/FirebaseCrashlytics.xcframework/Headers/*.h",
    "vendored/GoogleAppMeasurement.framework/Headers/*.h", 
    "vendored/FirebaseAnalytics.framework/Headers/*.h", 
    ...
    "vendored/FIRAnalyticsConnector.framework", 
    "vendored/GoogleAppMeasurement.framework", 
    "vendored/FirebaseAnalytics.framework", 
