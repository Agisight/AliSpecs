Pod::Spec.new do |s|
  ...
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
    ...
    #
    # May 13, 2021
    # CTM-3959 После нажатия кнопки отмены подписания внутри web view не обрабатывается ответ от DocuSign
    # volodymyrhulchenko
    # https://github.com/CT-Software/The-New-CT-Mobile/commit/398c162178337e1a1699f0c9373f404308d9d7a3

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4', :commit => '398c162178337e1a1699f0c9373f404308d9d7a3' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
