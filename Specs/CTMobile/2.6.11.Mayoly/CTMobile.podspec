Pod::Spec.new do |s|
  s.name         = 'CTMobile'
  s.version      = '2.6.11.Mayoly'
  s.summary      = 'The New CT Mobile'
  s.homepage     = 'https://github.com/CT-Software/The-New-CT-Mobile'
  s.license      = 'MIT'
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
  s.source       = { :git => 'git@github.com:CT-Software/The-New-CT-Mobile.git', :branch => '2.6.Mayoly', :commit => '1e1a4ed31d3725a17ab2afbc6253c32b12da01ba' }
  s.platform     = :ios, '12.1'
  s.requires_arc = true
