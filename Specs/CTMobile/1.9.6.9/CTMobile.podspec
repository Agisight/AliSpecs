Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
    ...
    core.dependency 'TPKeyboardAvoiding', '1.3.2'
  ...
  s.subspec 'Application' do |app|
    ...
    app.dependency 'XCDYouTubeKit', '2.7.3'
 ...
 s.subspec 'Routes' do |routes|
    ...
    routes.dependency 'DTCoreText', '1.6.21'
...
s.subspec 'NearbyAccounts' do |nearbyaccounts|
    ...
    nearbyaccounts.dependency 'DTCoreText', '1.6.21'
