Pod::Spec.new do |s|
  s.name         = 'CTMobile'
  s.version      = '2.6.14.Mayoly'
  s.summary      = 'The New CT Mobile'
  s.homepage     = 'https://github.com/CT-Software/The-New-CT-Mobile'
  s.license      = 'MIT'
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
  s.source       = { :git => 'git@github.com:CT-Software/The-New-CT-Mobile.git', :branch => '2.6.Mayoly', :commit => '54627a44639d62483fd05b5d0ec7946fa9fb3fba' }
  s.platform     = :ios, '12.1'
  s.requires_arc = true
