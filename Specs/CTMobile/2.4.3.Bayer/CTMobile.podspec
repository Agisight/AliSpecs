Pod::Spec.new do |s|
  ...
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
    ...
    #
    # May 7, 2021
    # CTM-3961 Ошибка создания JSON файлов по связанным объектам при ошибках доступа
    # etrishina
    # https://github.com/CT-Software/The-New-CT-Mobile/commit/4f7cbd8b79682b38da3f84efeee4f4fd276804bc

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4', :commit => '4f7cbd8b79682b38da3f84efeee4f4fd276804bc' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
