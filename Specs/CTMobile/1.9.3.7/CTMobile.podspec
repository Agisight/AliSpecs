Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/CT-Consulting/The-New-CT-Mobile.git', :branch => '1.9.3'}
  s.platform     = :ios, '9.0'
  s.requires_arc = true
  ...
  s.subspec 'Core' do |core|
    core.source_files = 'CTMobile.h', 'Core/Core/**/*.{h,m,mm,swift}', "vendored/WindowsAzureMobileServices.framework/Headers/*.h","vendored/WindowsAzureMessaging.framework/Headers/*.h","vendored/Crashlytics.framework/Headers/*.h","vendored/Fabric.framework/Headers/*.h"
    ...
    core.public_header_files = 'CTMobile.h', "Core/Core/**/*.h", "vendored/WindowsAzureMobileServices.framework/Headers/*.h","vendored/WindowsAzureMessaging.framework/Headers/*.h","vendored/Crashlytics.framework/Headers/*.h","vendored/Fabric.framework/Headers/*.h"
    core.libraries = "c++", "z"
    ...
    core.dependency 'Charts', '3.0.4'
    core.dependency 'Funnel'
    ...
    core.dependency 'CommonCryptoModule', '0.0.2'
