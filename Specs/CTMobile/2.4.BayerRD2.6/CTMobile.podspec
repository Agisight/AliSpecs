Pod::Spec.new do |s|
  s.name         = 'CTMobile'
  s.version      = '2.4.BayerRD2.6'
  s.summary      = 'The New CT Mobile'
  s.homepage     = 'https://github.com/CT-Software/The-New-CT-Mobile'
  s.license      = 'MIT'
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4.Bayer+RD2', :commit => '7c39844758258b806c58cd0103d9c4e1e04acc56' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
