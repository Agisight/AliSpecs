Pod::Spec.new do |s|
  ...
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
    ...
    #
    # May 18, 2021
    # CTM-3974 Во время подписания возвращать его результат
    # https://github.com/CT-Software/The-New-CT-Mobile/commit/3aa5fd61228d1c6823374b948f131fdb7731ef7a

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4', :commit => '3aa5fd61228d1c6823374b948f131fdb7731ef7a' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
