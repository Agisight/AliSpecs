Pod::Spec.new do |s|
  ...
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
    ...
    # project
    # etrishina
    # https://github.com/CT-Software/The-New-CT-Mobile/tree/adc2fac8da33544fb36a314c1df8fe9879358a70

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4', :commit => 'adc2fac8da33544fb36a314c1df8fe9879358a70' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
