Pod::Spec.new do |s|
  s.name         = 'CTMobile'
  s.version      = '2.4.Bayer+RD2.1'
  s.summary      = 'The New CT Mobile'
  s.homepage     = 'https://github.com/CT-Software/The-New-CT-Mobile'
  s.license      = 'MIT'
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4.Bayer+RD2', :commit => '78bc3f68a9c4dd06f3e90a597b56912710848381' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
