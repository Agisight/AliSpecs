Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/CT-Consulting/The-New-CT-Mobile', :tag => '1.4.5' }
  s.platform     = :ios, '7.0'
  s.requires_arc = true
  ...
  s.subspec 'Utils' do |utils|
    ...
    utils.dependency 'objective-zip'
    utils.dependency 'hpple'
    utils.dependency 'JGProgressHUD'
    utils.dependency 'Masonry'
    utils.dependency 'MTStatusBarOverlay'
    utils.dependency 'ZipArchive'
    utils.dependency 'PNChart'
    utils.dependency 'MDRadialProgress'
  end
  ...
  s.subspec 'Core' do |core|
    ...
    core.dependency 'CrashlyticsFramework'
 ...
 s.subspec 'Routes' do |routes|
    ...
    routes.dependency 'Google-Maps-iOS-SDK'
...
s.subspec 'NearbyAccounts' do |nearbyaccounts|
    ...
    nearbyaccounts.vendored_frameworks = 'NearbyAccounts/GoogleMaps.framework'

    nearbyaccounts.dependency 'CTMobile/Core'
