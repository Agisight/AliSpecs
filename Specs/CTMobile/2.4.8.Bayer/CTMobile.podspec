Pod::Spec.new do |s|
  ...
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
    ...
    #
    # May 21, 2021
    # CTOM-2064: Добавление нидерландского языка
    # https://github.com/CT-Software/The-New-CT-Mobile/commit/f82dd6a8f80cde7b41aad93efd92afda051972cb

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4.Bayer', :commit => 'f82dd6a8f80cde7b41aad93efd92afda051972cb' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
