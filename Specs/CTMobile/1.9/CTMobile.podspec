Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/CT-Consulting/The-New-CT-Mobile.git', :branch => '1.9' }
  s.platform     = :ios, '8.0'
  s.requires_arc = true
  ...
  s.subspec 'Synchronization' do |synchr|
    ...
    synchr.dependency 'objective-zip', '0.8.3'
    synchr.dependency 'AFNetworking-Synchronous/2.x'
  ...
  s.subspec 'Core' do |core|
    ...
    core.source_files = 'Core/Core/**/*.{h,m,mm}', "vendored/WindowsAzureMobileServices.framework/Headers/*.h","vendored/WindowsAzureMessaging.framework/Headers/*.h","vendored/Crashlytics.framework/Headers/*.h","vendored/Fabric.framework/Headers/*.h"
    ...
    core.vendored_frameworks = "vendored/WindowsAzureMessaging.framework","vendored/WindowsAzureMobileServices.framework","vendored/Crashlytics.framework","vendored/Fabric.framework"
    s.public_header_files = "vendored/WindowsAzureMobileServices.framework/Headers/*.h","vendored/WindowsAzureMessaging.framework/Headers/*.h","vendored/Crashlytics.framework/Headers/*.h","vendored/Fabric.framework/Headers/*.h"
    ...
    core.dependency 'ALAssetsLibrary-CustomPhotoAlbum', '~> 1.3'
    core.dependency 'MTDates'
    core.dependency 'SWRevealViewController', '~> 2.3'
  ...
  s.subspec 'Account' do |account|
    account.source_files = 'Account/Account/**/*.{h,m,mm}','vendored/GoogleMaps.framework/Headers/*.h'
    ...
    account.vendored_frameworks = "vendored/GoogleMaps.framework"
    account.public_header_files = "vendored/GoogleMaps.framework/Headers/*.h"
    account.xcconfig = {'OTHER_LDFLAGS' => '-ObjC'}
  ...
  s.subspec 'Application' do |app|
    ...
    app.dependency 'QRCodeReaderViewController', '4.0.1'

    app.framework    = 'MultipeerConnectivity'
  end

 s.subspec 'Routes' do |routes|
    routes.source_files = 'Routes/Routes/**/*.{h,m,mm}', 'vendored/GoogleMaps.framework/Headers/*.h'
    ...
    routes.public_header_files = 'vendored/GoogleMaps.framework/Headers/*.h'
...
s.subspec 'NearbyAccounts' do |nearbyaccounts|
    nearbyaccounts.source_files = 'NearbyAccounts/NearbyAccounts/**/*.{h,m,mm}', 'vendored/GoogleMaps.framework/Headers/*.h'
    ...
    nearbyaccounts.vendored_frameworks = 'vendored/GoogleMaps.framework'
    nearbyaccounts.public_header_files = 'vendored/GoogleMaps.framework/Headers/*.h'
  ...
  s.subspec 'DocumentFormer' do |documentformer|
      ...
      documentformer.prefix_header_file = 'DocumentFormer/DocumentFormer/DocumentFormer-Prefix.pch'
  ...
  s.subspec 'LinkList' do |linklist|
      linklist.source_files = 'LinkList/LinkList/**/*.{h,m,mm}'
      linklist.exclude_files = '**/main.m'
      linklist.resources    = 'LinkList/LinkList/**/*.{storyboard,png,xib,bundle,framework}'
      linklist.prefix_header_file = 'LinkList/LinkList/LinkList-Prefix.pch'
