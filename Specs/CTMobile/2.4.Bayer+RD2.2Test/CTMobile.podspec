Pod::Spec.new do |s|
  s.name         = 'CTMobile'
  s.version      = '2.4.Bayer+RD2.2Test'
  s.summary      = 'The New CT Mobile'
  s.homepage     = 'https://github.com/CT-Software/The-New-CT-Mobile'
  s.license      = 'MIT'
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4.Bayer+RD2', :commit => '10dd38aaf701b9977034e4517c20608b351ba3eb' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
  ...
  s.subspec 'Utils' do |utils|
    ...
    utils.dependency 'DFCache', '4.0.2'
    utils.dependency 'SnapKit', '5.0.1'
...
s.subspec 'NearbyAccounts' do |nearbyaccounts|
  ...
  s.subspec 'Presenter' do |presenter|
    ...
    presenter.dependency 'JitsiMeetSDK', '3.10.4'
