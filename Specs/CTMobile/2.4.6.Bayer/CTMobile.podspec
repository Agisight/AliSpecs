Pod::Spec.new do |s|
  ...
  s.author       = { 'gtarasov' => 'gleb34@gmail.com' }
    ...
    #
    # May 17, 2021
    # CTM-3973 Обработка ContentVersion и ContentDocumentLink в логике SyncRecovery
    # https://github.com/CT-Software/The-New-CT-Mobile/commit/12cbc5787ae39a86f80510bb19ba28843b82036d

  s.source       = { :git => 'https://github.com/CT-Software/The-New-CT-Mobile', :branch => '2.4', :commit => '12cbc5787ae39a86f80510bb19ba28843b82036d' }
  s.platform     = :ios, '11.0'
  s.requires_arc = true
